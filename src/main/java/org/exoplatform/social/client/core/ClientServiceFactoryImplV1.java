 ...
 * @since 1.0.0-alpha2
 */
public class ClientServiceFactoryImplV1 implements ClientServiceFactory {
  ...
  public ActivityService createActivityService() {
    if (activityService == null) {
      activityService = new ActivityServiceImplV1();
    }
  ...
  public IdentityService createIdentityService() {
    if (identityService == null) {
      identityService = new IdentityServiceImplV1();
    }
