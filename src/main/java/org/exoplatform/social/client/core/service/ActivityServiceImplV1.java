...
import org.exoplatform.social.client.core.service.ActivitiesRealtimeListAccessV1.ActivityType;
 ...
 * @since Jun 28, 2011
 */
public class ActivityServiceImplV1 extends ServiceBase<RestActivity, ActivityService<RestActivity>> implements ActivityService<RestActivity> {
  ...
  public RestActivity create(RestActivity newInstance) throws SocialClientLibException {
    final String POST_ACTIVITY_REQUEST_URL = BASE_URL+"activity.json";
      try{
        ...
        throw new ServiceException(ActivityServiceImplV1.class,e.getMessage(), e);
  ...
  public RealtimeListAccess<RestActivity> getActivityStream(RestIdentity restIdentity, QueryParams queryParams) throws SocialClientLibException {
    return new ActivitiesRealtimeListAccessV1(restIdentity, ActivityType.ACTIVITY_STREAM, queryParams);
  }
  ...
  public RealtimeListAccess<RestActivity> getSpacesActivityStream(RestIdentity userRestIdentity, QueryParams queryParams)
                                                                                  throws SocialClientLibException {
    return new ActivitiesRealtimeListAccessV1(userRestIdentity, ActivityType.USER_SPACE_ACTIVITIES, queryParams);
  }
  ...
  public RealtimeListAccess<RestActivity> getConnectionsActivityStream(RestIdentity restIdentity, QueryParams queryParams) 
                                                                                              throws SocialClientLibException {
    return new ActivitiesRealtimeListAccessV1(restIdentity, ActivityType.CONNECTIONS_ACTIVITIES, queryParams);
  }
  ...
  public RealtimeListAccess<RestActivity> getFeedActivityStream(RestIdentity userRestIdentity , QueryParams queryParams)
                                                                                  throws SocialClientLibException {
    return new ActivitiesRealtimeListAccessV1(userRestIdentity, ActivityType.ACTIVITY_FEED, queryParams);
  }
  ...
  public RestLike like(RestActivity existingRestActivity) throws SocialClientLibException{
    ...
    try{
      ...
      if((Boolean) responseJson.get("liked")){
        ...
        throw new ServiceException(ActivityServiceImplV1.class, "invalid response", null);
      }
    } catch (SocialHttpClientException e) {
      throw new ServiceException(ActivityServiceImplV1.class, "invalid response", null);
    }
